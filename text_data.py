...
(0,2,'Introdução','Até o dia em que a corrida pela evolução e crescimento da civilização se tornou uma realidade problemática,','tomando conta dos Vastayas, e fazendo estes esquecerem oque já sabiam deste sempre','a importância de se viver em paz e harmonia com a natureza.'),
...
(0,0,'Introdução','E aqui esta ele Glusternio o Vastaya escolhido pelo povo para governar','sobre a promessa de mudar esse cenário, e visando alcançar o sonho','de uma vida onde o progresso e a harmonia com a natureza andem de mãos dadas.'),
(0,0,'Introdução','Seu dever como representante dos Vastayas é governar visando salvar a natureza,','para isso você deve entender das necessidades ecológicas de uma sociedade,','e evitar iniciativas baseadas em mentiras, ja que estas causam uma perda de tempo e recurso,', 'que poderiam ser utilizadas em uma iniciativa com real impacto ecológico.'),
...
(0,0,'Glusternio','*'),
(2,1,'Exigir uma multa para poluírem livremente o rio','Deixar como está porque as empresas estão gerando lucro','Fechar as empresas sem contestações','Exigir que as empresas façam um descarte consciente','As fábricas da cidade estão poluindo o rio.','o que um dia foi um símbolo do vínculo da cidade', 'com a natureza, agora esta perecendo.','Como você ira intervir?'),
(0,1,'Glusternio','*'),
(2,1,'Criar lei obrigando o reflorestamento','Proibir retirada de madeira por completo','Queimar todas florestas','Demitir todos envolvidos','As empresas estão desmatando as florestas em', 'torno da cidade em busca de matéria prima.','O que você vai fazer a respeito?'),
(0,1,'Glusternio','*'),]
